...
return {
Lock     = '[𝘚𝘰𝘶𝘳𝘤𝘦 RedBull](https://t.me/allush3)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه المسح *',
unLock   = '[𝘚𝘰𝘶𝘳𝘤𝘦 RedBull](https://t.me/allush3)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n'..TextMsg,
lockKtm  = '[𝘚𝘰𝘶𝘳𝘤𝘦 RedBull](https://t.me/allush3)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه الكتم *',
lockKid  = '[𝘚𝘰𝘶𝘳𝘤𝘦 RedBull](https://t.me/allush3)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه التقييد *',
lockKick = '[𝘚𝘰𝘶𝘳𝘤𝘦 RedBull](https://t.me/allush3)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n‹ : بواسطه ← *'..UserInfousername..'\n*'..TextMsg..'\n‹ : خاصيه الطرد *',
Reply    = '[𝘚𝘰𝘶𝘳𝘤𝘦 RedBull](https://t.me/allush3)\n*⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n🔰 : المستخدم⇷ *'..UserInfousername..'\n*'..TextMsg..'*'
}
end
...
local N = (Redis:get(Thepirlo.."Name:Bot") or "بلاك")
...
{
{text = '𝘚𝘰𝘶𝘳𝘤𝘦 RedBull', url='https://t.me/allush3'},
},
}
}
...
return LuaTele.sendText(msg.chat_id,msg.id,'*\n‹ : عمري اشترك ثم استخدم الامر❗️*',"md",false, false, false, false, reply_markup)
end
...
NamesBot = (Redis:get(Thepirlo.."pirlo:Name:Bot") or "بلاك")
...
{
{text = Jabwa, url = 'https://t.me/K_S_K6'}, 
},
{
{text = Grosupsw, url = 'https://t.me/allush3'}, 
},
{
{text = Usperos, url = 'https://t.me/allush3'}, 
},
}
...
return LuaTele.sendText(msg_chat_id,msg_id,'\n*‹ : اهلا بك مجددا عزيزي \n‹ : اليك الازرار الخاصه بأوامر التسليه الخاصه بسورس  ريد بولفقط اضغط على الامر الذي تريد تنفيذه *','md', true, false, false, false, reply_markup)
end
...
{{text =news,url = "https://t.me/allush3"}, },}}
...
if text == "غنيلي" then
Abs = math.random(2,140); 
local Text =" [‹ : تم اختيار الاغنيه لك : -](t.me/allush3)"
keyboard = {} 
keyboard.inline_keyboard = {
{
...
if text == "شعر" then
Abs = math.random(2,140); 
local Text =" [‹ : تم اختيار الشعر لك :  ](t.me/allush3)"
keyboard = {} 
keyboard.inline_keyboard = {
{
...
{
{text = '𝘚𝘰𝘶𝘳𝘤𝘦 RedBull',url="t.me/allush3"}
},
{
...
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendVoice?chat_id=' .. msg.chat_id .. '&voice=https://t.me/https://t.me/allush3/'..Abs..'&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
...
if photo.total_count > 0 then
local TestText = "  𝘚𝘰𝘶𝘳𝘤𝘦 RedBull\n⋆┄┄─┄─┄─┄┄─┄─┄┄⋆\n ‹ : *Dev Name* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n‹ : *Dev Bio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ 𝖼𝗈𝖽𝖾𝗋 ❳', url = "https://t.me/K_S_K6"}
},
{
{text = '𝘚𝘰𝘶𝘳𝘤𝘦 RedBull', url='https://t.me/allush3'},
},
...
local UserId_Info = LuaTele.searchPublicChat("@allush3")
if UserId_Info.id then
local UserInfo = LuaTele.getUser(UserId_Info.id)
local InfoUser = LuaTele.getUserFullInfo(UserId_Info.id)
if InfoUser.bio then
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𝗎𝗉𝖽𝖺𝗍𝖾’s ❳', url = "https://t.me/allush3"}
},
{
{text = '𝘚𝘰𝘶𝘳𝘤𝘦 RedBull', url='https://t.me/allush3'},
},
...
{{text = 'Delete Instagram',url="https://www.instagram.com/accounts/login/?next=/accounts/remove/request/permanent/"},{text = 'Delete snapchat',url="https://accounts.snapchat.com/accounts/login?continue=https%3A%2F%2Faccounts.pirlochat.com%2Faccounts%2Fdeleteaccount"}},{{text= ' سورس  ريد بول',url="t.me/allush3"}}
}
local msg_id = msg.id/2097152/0.5
...
keyboard.inline_keyboard = {
{
{text = '𝗎𝗉𝖽𝖺𝗍𝖾𝗌', url = 'https://t.me/allush3'},{text = '. ‹ 𝘚𝘰𝘶𝘳𝘤𝘦 RedBull', url = 'https://t.me/allush3'}, 
},
{
{text = 'مبرمج السورس', url = 't.me/K_S_K6'}, 
},
}
local msg_id = msg.id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id=' .. msg.chat_id .. '&photo=https://t.me/allush3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "منو اني" then
if msg.sender.user_id == tonumber(5148378105) then
LuaTele.sendText(msg_chat_id,msg_id,"‹ : انت بلاك مطور السورس يقلبي🌚💘","md",true)
...
if text == (Redis:get(Thepirlo.."pirlo:Name:Bot") or "بلاك") then
local NamesBot = (Redis:get(Thepirlo.."pirlo:Name:Bot") or "بلاك")
local NameBots = {
"يروح "..NamesBot.. " كول؟",
"انا "..NamesBot.. " القميل",
"هاعمري",
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 'https://t.me/allush3'}, 
},
{
...
"اختفوووو يلعار ابلع من عمك بلاك??🏃‍♀️.",
...
elseif text == "اسفه" then LuaTele.sendText(msg_chat_id,msg_id,"لا تعـ͜يدِها بـعدِ",'md')
elseif text == "اسف" then LuaTele.sendText(msg_chat_id,msg_id,"لآتـــعيديها بــعدٰ💘",'md')
...
{
{text = '‹ : شروحات السورس -', url = 't.me/allush3'},
},
{
{text = '‹ : سۅرس  ريد بول-', url = 't.me/allush3'},
},
}
}
...
{
{text = '‹ : شروحات السورس', url = 't.me/allush3'}, {text = '‹ : شراء بوت', url = 't.me/K_S_K6'},
},
{
{text = '‹ : 𝘚𝘰𝘶𝘳𝘤𝘦 RedBull .', url = 't.me/allush3'},
},
...
reply_markup = {
inline_keyboard ={
{{text ="ch", url= "https://t.me/allush3"}},
}
},
},
}
...
if tonumber(IdUser) == tonumber(UserId) then
Abs = math.random(2,54); 
local Text ='* 𝘚𝘰𝘶𝘳𝘤𝘦 RedBull\n⋆┄┄─┄─┄─┄┄─┄─┄┄⋆*'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝘚𝘰𝘶𝘳𝘤𝘦 RedBull',url="https://t.me/allush3"},{text = ' Updates source ⁦ᯓ',url="https://t.me/allush3"}
},
{
{text = ' مبرمج السورس',url="https://t.me/K_S_K6"}
},
}
local msg_id = Msg_id/2097152/0.5
...
local TextHelp = [[*
‹ : أهلا بك في قائمة العاب سورس  ريد بولاختر نوع الالعاب 
*]]
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
...
local TextHelp = [[*
‹ : مرحبا بك في الالعاب المتطورة الخاص بسورس  ريد بول
